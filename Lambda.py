...
```````````````````````````````````````````````````````````````````````````````````````````````````````````````
#sconesunlimited-data-classification- inferSerializedImageData: a lambda function for invoking the model endpoint and returning inferences
...
ENDPOINT = "image-classification-2023-02-03-02-56-26-047"
